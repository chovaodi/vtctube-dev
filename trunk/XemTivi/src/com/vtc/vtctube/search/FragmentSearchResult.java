...
public class FragmentSearchResult extends Fragment implements OnScrollListener {
    ...
    public static FragmentSearchResult newInstance(String num, String keyword, int keyOtion) {
        // if (frament == null)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        json = (String) (getArguments() != null ? getArguments().getString("num") : 1);
        keyword = (String) (getArguments() != null ? getArguments().getString("keyword") : 1);
        keyOption = (int) (getArguments() != null ? getArguments().getInt("keyOtion") : 1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fotter = getActivity().getLayoutInflater().inflate(R.layout.fotter_loadmore, null);
        ...
        if ((lastInScreen == totalItemCount)) {
            ...
            if (!isLoadding) {
                ...
                if (keyOption == Utils.LOAD_SEARCH) {
                    url = Utils.host + "get_search_results?search=" + keyword + "&count=" + pageSize + "&page=" + page;
                } else {
                    url = Utils.host + "get_posts?count=10&page=" + page + "&cat=" + MainActivity.currentCate;
                }
                new AysnRequestHttp((ViewGroup) view, Utils.LOAD_MORE, MainActivity.smooth, callBack).execute(url);
