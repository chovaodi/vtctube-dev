package com.vtc.basetube.services.volley.ssl;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static final int CERTIFICATE_RESOURCE_CLIENT = 0; // R.raw.production_test_client
    private static final int CERTIFICATE_RESOURCE_CA = 0; // R.raw.production_test_client_ca

    private SSLContext sslcontext = null;
    private boolean isConnectingYourServer = true;
    private Context mContext;

    public EasySSLSocketFactory(Context context, boolean isConnectingYourServer) {
        this.isConnectingYourServer = isConnectingYourServer;
        mContext = context;
    }
    ...
    private SSLContext getSSLContext() throws IOException {
        if (this.sslcontext == null) {
            if (isConnectingYourServer) {
                this.sslcontext = createEasySSLContext(mContext);
            } else {
